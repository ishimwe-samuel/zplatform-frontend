...
export default function UsersList() {
  ...
  return (
    <>
      <NavigationBar />
      <>
        <div className="flex flex-col w-4/5 justify-center border rounded-md p-5 m-5 ">
              ...
              <div className="overflow-hidden">
                ...
                <table className="min-w-full text-left text-sm font-light">
                  ...
                  <tbody>
                    {users.map((user, idx) => {
                      return (
                        <tr className="border-b dark:border-neutral-500 hover:bg-gray-200 cursor-pointer">
